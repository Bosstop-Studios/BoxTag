package ml.bosstop.boxtag.util;

import com.google.gson.Gson;
import ml.bosstop.boxtag.Main;
import ml.bosstop.boxtag.util.models.Note;
...
public class Storage {
    ...
    public static void createNote(UUID id){
    ...
    public static boolean findNoteExist(UUID id) {
        for (Note note : players) {
            return note.getId().equalsIgnoreCase(String.valueOf(id));
        }
        return false;
    }
